...
function Navbar() {
  ...
  return (
    <div
      className={`max-w-screen-2xl container mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 dark:bg-slate-900 dark:text-white ${
        sticky
      ...
      <div className="navbar ">
        ...
        <div className="navbar-end">
          ...
          <label className="swap swap-rotate">
            ...
            {/* moon icon */}
            <svg
              className=" mr-2 swap-on fill-current w-8 h-8"
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
